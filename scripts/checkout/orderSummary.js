...
export function renderOrderSummary() {
  ...
  cart.cartItems.forEach((cartItem) => {
    ...
    //view
    cartSummaryHTML += `        
              <div class=" not-editing cart-item-container js-cart-item-container js-cart-item-container-${
                matchingProduct.id
              }">
                  ...
                  <div class="cart-item-detail">
                    ...
                    <div class="product-quantity js-product-quantity-${
                      ...
                      <input data-product-id="${
                        matchingProduct.id
                      }"class="quantity-link quantity-input  js-quantity-input js-quantity-${
      matchingProduct.id
    }">
                      <span data-product-id="${
                        matchingProduct.id
                      }" class="save-quantity-link js-save-quantity-link link-primary quantity-input">Save</span>
                      <span class="delete-quantity-link  js-delete-link link-primary js-delete-link-${
                        matchingProduct.id
                      }" data-product-id="${matchingProduct.id}"> 
                        Delete
                      </span>
                    </div>
                    <div class="invalid-quantity js-invalid-quantity-${
                      matchingProduct.id
                    }">
  ...
  document.querySelectorAll(`.js-quantity-input`).forEach((saveLink) => {
    const { productId } = saveLink.dataset;
  ...
  if (cart.cartItems < 1) {
    ...
    document.querySelector(".js-buy-items").addEventListener("click", () => {
